...
//     version 1.6.3
//     from Assets/Input/gameManagementInput.inputactions
//
...
public partial class @GameManagementInput: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @GameManagementInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""gameManagementInput"",
    ""maps"": [
        {
            ""name"": ""tank1"",
    ...
    {
        private @GameManagementInput m_Wrapper;
        public Tank1Actions(@GameManagementInput wrapper) { m_Wrapper = wrapper; }
